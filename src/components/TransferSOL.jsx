    ...
    return (
        <div className="mt-20 flex justify-center  p-5 w-[30vw] items-center rounded-lg bg-white">
            ...
            <form action="" className='flex flex-col items-center gap-3' onSubmit={sendSol}>
                ...
                <input type="text" value={0} placeholder='amount' onChange={(e) => setAmount(e.target.value)} className='bg-black placeholder:text-white text-white w-[25vw] px-3 py-[9px] rounded-lg border' />
